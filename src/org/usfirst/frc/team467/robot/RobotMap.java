...
public class RobotMap {
	...
	public static void init(RobotID id) {
		...
		case Competition_1:
			...
			// Turn PIDs
			LEFT_TURN_PID_P = 2.025;//0.44;
			LEFT_TURN_PID_I = 0.0003;
			LEFT_TURN_PID_D = 400.0;//153.0;
			LEFT_TURN_PID_F = 0.0;

			RIGHT_TURN_PID_P = 2.025;//0.44;
			RIGHT_TURN_PID_I = 0.0003;
			RIGHT_TURN_PID_D = 400.0;//153.0;
