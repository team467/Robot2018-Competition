...
// LOOGER.info("WRITE SOMETHING IN HERE WITH: {}" WriteVaribleHere(), andHereIfThereIsAnotherOne());		
		...
		config.addLogger(Climber.class.getName(), new LoggerConfig(Climber.class.getName(), Level.WARN, true));
//		config.addLogger(Action.class.getName(), new LoggerConfig(Action.class.getName(), Level.WARN, true));
...
//		config.addLogger(DriveSimulator.class.getName(), new LoggerConfig(DriveSimulator.class.getName(), Level.WARN, true));
		config.addLogger(Elevator.class.getName(), new LoggerConfig(Elevator.class.getName(), Level.WARN, true));
		config.addLogger(Grabber.class.getName(), new LoggerConfig(Grabber.class.getName(), Level.WARN, true));
		config.addLogger(MatchConfiguration.class.getName(), new LoggerConfig(MatchConfiguration.class.getName(), Level.WARN, true));
//		config.addLogger(OpticalSensor.class.getName(), new LoggerConfig(OpticalSensor.class.getName(), Level.WARN, true));
//		config.addLogger(Ramp.class.getName(), new LoggerConfig(Ramp.class.getName(), Level.WARN, true));
//		config.addLogger(Ramps.class.getName(), new LoggerConfig(Ramps.class.getName(), Level.WARN, true));
//		config.addLogger(org.usfirst.frc.team467.robot.simulator.Robot.class.getName(), 
//				new LoggerConfig(org.usfirst.frc.team467.robot.simulator.Robot.class.getName(), Level.WARN, true));
