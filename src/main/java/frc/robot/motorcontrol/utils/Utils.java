package frc.robot.motorcontrol.utils;
...
public class Utils {
    ...
    public static double[] listToArray(ArrayList<Double> list) {
        // Frikin complicated way to convert from a array list that knows it has doubles to an array of doubles due to null handling issues.
